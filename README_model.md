...
<p align="center"><img alt="\begin{align*}&#10;     {V}_i| {k}, {Z}, {w}_i, {B},\sigma_{\epsilon}^2 &amp; \sim  {N}_S( {B} {X}_i+ {Q}(k) {Z} {w}_i,\sigma_{\epsilon}^2 {I}_S), \quad \text{for } i=1,\dots,n \\&#10;    [ {B}, \sigma_{\epsilon}^2] &amp; \propto \frac{1}{\sigma_{\epsilon}^2} \\&#10;     {w}_i &amp; \sim  {N}_r( {0}, {I}_r) \\&#10;    k_l| {p} &amp; \overset{ \text{iid} }{ \sim } \sum_{j=1}^N p_j\delta_j(k_l), \quad \text{for } l=1,\dots S \\&#10;     {Z}_j| {D_z} &amp; \overset{ \text{iid} }{ \sim }  {N}_r( {0}, {D_z}), \quad \text{for } j=1,\dots N \\&#10;     {p} &amp; \sim  {GD}_N(a_{\alpha},b_{\alpha})\\&#10;     {D_z} &amp; \sim  {IW}(2+r-1,4\text{diag}(\frac{1}{\eta_1},\dots, \frac{1}{\eta_r})) \\&#10;    \eta_h &amp; \sim  {IG}(\frac{1}{2},\frac{1}{10^4}), \quad \text{for } h=1,\dots, r&#10;\end{align*}" src="https://rawgit.com/leegao/readme2tex (fetch/None/svgs/d9b3e28522ceaa0c7052b56d86f08d88.svg" align="middle" width="464.22022185000003pt" height="288.38918625pt"/></p>
